...
var msgInfo_ER_MW4 =kg + msgerr + "真实姓名不能为空！";
var msgInfo_ER_MW5 =kg + msgerr + "身份证号码不能为空！";
...
var msgInfo_ER01 =kg + msgerr + "6-16位小写英文字母和数字组成，首位为字母";
var msgInfo_ER02 =kg + msgerr + "长度不能小于6个字符，且不能大于16个字符。";

var msgInfo_ER11 =kg + msgerr + "密码长度必须大于8位且小于16位。";
var msgInfo_ER12 =kg + msgerr + "密码不能与账号名相同。";
var msgInfo_ER13 =kg + msgerr + "密码不能含\".\"符号。";
var msgInfo_ER21 =kg + msgerr + "两次输入的密码不一致，请重新输入确认密码。";

var msgInfo_ER41 =kg + msgerr + "密码提示答案长度必须在6-18位。";
...
var msgInfo_ER121 =kg + msgerr + "密码长度必须大于8位且小于16位。";
...
msgInfo_DE0 =kg + "6-16位小写英文字母和数字组成，首位为字母";

msgInfo_DE1 =kg + "8-16位，字母区分大小写，不能用符号“.”";
msgInfo_DE2 =kg + "请再次输入您的密码。";
msgInfo_DE3 =kg + "请选择密码提示问题。";
msgInfo_DE4 =kg + "请您填写密码提示答案，长度必须在6-18位字符。";
...
checkArr[0]=new Array("_user_name",true,"_user_name_info",style_DF,style_OK,style_ER,msgInfo_DE0,divBegin+msgInfo_DE0+divEnd,"checkUserName",
	...
	new Array(divBegin_ER+msgInfo_ER02+divEnd,'LENGTH',6,16)
	);
...
checkArr[1]=new Array("_user_passwd",true,"_user_passwd_info",style_DF,style_OK,style_ER,msgInfo_DE1,divBegin+msginfo_ok+divEnd,null,
	...
	new Array(divBegin_ER+msgInfo_ER11+divEnd,'LENGTH',8,16)
...
checkArr[5]=new Array("_user_superpwd",true,"_user_superpwd_info",style_DF,style_OK,style_ER,msgInfo_DE12,divBegin+msginfo_ok+divEnd,null,
	...
	new Array(divBegin_ER+msgInfo_ER121+divEnd,'LENGTH',8,16),
...
checkArr[6]=new Array("_user_superpwd2",true,"_user_superpwd2_info",style_DF,style_OK,style_ER,msgInfo_DE15,divBegin+msginfo_ok+divEnd,null,
	...
	checkArr[7]=new Array("_rand_code",true,"_rand_code_info",style_DF,style_OK,style_ER,msgInfo_DE13,divBegin+msginfo_ok+divEnd,"checkValidCode",
	new Array(divBegin_ER+msgInfo_ER_MW10+divEnd,'EMPTY')
	);	
	checkArr[8]=new Array("_user_realname",true,"_user_realname_info",style_DF,style_OK,style_ER,msgInfo_DE17,divBegin+msginfo_ok+divEnd,null,
	new Array(divBegin_ER+msgInfo_ER_MW4+divEnd,'EMPTY'),
	new Array(divBegin_ER+msgInfo_ER171+divEnd,'CHINANAME'),
	new Array(divBegin_ER+msgInfo_ER171+divEnd,'LENGTH',4,12)
	);
