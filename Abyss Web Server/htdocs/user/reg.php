...
if($_POST)
{
	...
	//账号是否可用
	$sql="select name from account where name='$POST[_user_name]'";
	$accountid=$connobj->queryone($sql);
	if($accountid) die("<script>alert('账号 ".$POST['_user_name']." 已被注册,请重新注册');history.back();</script>");
		$sql="INSERT INTO  account (name,password,phone,email,address,idnumber) VALUES ('$POST[_user_name]','$POST[_user_passwd]','$POST[_user_superpwd2]','bbssee','$POST[_user_email2]','$POST[_user_idcard]')";
...
class=required>*</SPAN>游戏账号：</LABEL> <INPUT class="i-text f_l" id=_user_name
onblur="NewAjaxFunc().CheckUserInput('username',this,username_exist,username_not_exist);"
name=_user_name>
<DIV class=fm-explain id=_user_name_info>6-16位小写英文字母和数字组成，首位为字母</DIV></DIV>
<DIV class=line></DIV>
<DIV class=fm-part>
<DIV class=fm-item><LABEL class=fm-label><SPAN
class=required>*</SPAN>登录密码：</LABEL> <INPUT class="i-text f_l" id=_user_passwd
type=password name=_user_passwd>
<DIV class=fm-explain id=_user_passwd_info>8-16位，字母区分大小写，不能用符号“.”</DIV></DIV>
<DIV class=kg></DIV>
<DIV class=fm-item><LABEL class=fm-label><SPAN
...
<DIV class=kg></DIV>
<DIV class=fm-item><LABEL class=fm-label>密码安全级别：</LABEL>
<DIV class=f_l>
<SCRIPT language=javascript type=text/javascript>
...
<DIV class=tab>建议您使用英文，数字混合的密码并增加长度</DIV></DIV>
<DIV class=line></DIV>
<DIV class=fm-part>
<DIV class=fm-item><LABEL class=fm-label><SPAN
class=required>*</SPAN>真实姓名：</LABEL> <INPUT class="i-text f_l" id=_user_realname
name=_user_realname>
<DIV class=fm-explain id=_user_realname_info>请输入真实姓名</DIV></DIV>
<DIV class=kg></DIV>
<DIV class=fm-item><LABEL class=fm-label><SPAN
class=required>*</SPAN>身份证号码：</LABEL> <INPUT class="i-text f_l" id=_user_idcard
name=_user_idcard>
<DIV class=fm-explain id=_user_idcard_info>判断账号归属依据，注册后不能修改</DIV></DIV></DIV>
<DIV class=line></DIV>
<DIV class=fm-part>
<DIV class=fm-item><LABEL class=fm-label><SPAN
class=required>*</SPAN>安全邮箱：</LABEL> <INPUT class="i-text f_l" id=_user_email
name=_user_email>
<DIV class=fm-explain id=_user_email_info>修改登录密码的依据，请务必仔细填写并牢记</DIV></DIV>
<DIV class=kg></DIV>
<DIV class=fm-item><LABEL class=fm-label><SPAN
class=required>*</SPAN>再次输入安全邮箱：</LABEL> <INPUT class="i-text f_l"
id=_user_email2 name=_user_email2>
<DIV class=fm-explain id=_user_email2_info>再次输入安全邮箱</DIV></DIV></DIV>
<DIV class=line></DIV>
<DIV class=fm-part>
<DIV class=fm-item><LABEL class=fm-label><SPAN
