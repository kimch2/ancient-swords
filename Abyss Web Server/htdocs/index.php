...
<div class="bg">
    <div class="loing">
      <form onsubmit="return check_input();" target="_self" id="frm_center" name="frm_center" method="get" action="/enter/login.php">
    ...
    <a class="txtan an4" target="_blank" href="#">游戏大厅</a>
    <a class="txtan an6" target="_blank" href="#">进入官网</a>
    <a class="txtan an7" target="_blank" href="/user/reg.php">注册账号</a>
