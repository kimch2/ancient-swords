...
$_LANG['app_name'] = '御剑江湖';
$_LANG['cp_home'] = '御剑江湖管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2005-2010 广州御剑网络科技有限公司，并保留所有权利。版本号：kl.1.0.0';
...
/* 菜单分类部分 */
$_LANG['charge_consume_manage']= '充值消费统计管理';
...
$_LANG['01_charge_consume_manage'] = '充值消费管理';
$_LANG['02_resource'] = '资源管理工具';
$_LANG['03_player_manage'] = '玩家管理';
$_LANG['04_report_manage'] = '报表分析';
$_LANG['05_tool_manage'] = '常用工具';
$_LANG['06_compensation_manage'] = '补偿仓库';
...
/* 充值消费统计 */
$_LANG['py_statics'] = '充值消费统计';
$_LANG['py_list'] = '充值记录列表';
$_LANG['py_yb'] = '元宝充值记录';
$_LANG['all_statics'] = '全平台充值统计';
$_LANG['view_all_statics'] = '查看所有平台充值数据';


/* 资源管理工具 */
$_LANG['yb_res'] = '元宝充值工具';
$_LANG['zb_res'] = '珠宝充值工具';
$_LANG['card_res'] = '卡片生成器';
$_LANG['goods_res'] = '添加物品';
$_LANG['act_manage'] = '活动管理';

$_LANG['mkdk_card'] = '多卡生成器';
$_LANG['dianjuan'] = '点卷补偿';
$_LANG['ex_paymodes'] = '充值补单工具';



/* 玩家管理 */
$_LANG['player_ranking'] = '玩家充值排行';
$_LANG['player_list'] = '玩家列表';
$_LANG['player_equire'] = '玩家装备查询';
$_LANG['player_skill'] = '玩家技能查询';
$_LANG['player_pet'] = '玩家宠物查询';
$_LANG['player_goods'] = '玩家商品购买查询';
$_LANG['player_searchpwd'] = '玩家密码查询';
$_LANG['player_setitempwd'] = '重置物品密码锁';
$_LANG['player_game_log'] = '贵重物品使用查询';

$_LANG['search_mob'] = '手机礼包到账查询';

$_LANG['player_first_pay'] = '首充查询';
$_LANG['player_consumelog'] = '元宝及点券消费记录';
$_LANG['player_ticketlog'] = '元宝票明细';
$_LANG['big_yb'] = '巨额元宝玩家';


/* 报表分析 */
$_LANG['report_online_num'] = '在线人数统计';
$_LANG['report_rate_num'] = '各等级人数统计';
$_LANG['report_player_new'] = '新增玩家统计';
$_LANG['report_player_create'] = '创建角色流失率统计';
$_LANG['report_player_lost'] = '流失率统计';
$_LANG['report_sell_day'] = '每日商品售出统计';
$_LANG['report_sell_all'] = '商品售出统计';
$_LANG['report_all_ptcz'] = '全平台充值统计';
$_LANG['report_czall'] = '全服充值统计';
$_LANG['report_czday'] = '每日充值统计';
$_LANG['report_czmonth'] = '每月充值统计';
$_LANG['report_all_ptxf'] = '全平台消费统计';
$_LANG['report_allconsume'] = '全服消费统计';
$_LANG['report_dayconsume'] = '每日消费统计';
$_LANG['report_monthconsume'] = '每月消费统计';



/*常用工具*/
$_LANG['tool_newuser'] = '设置新手指导员';
$_LANG['edit_pwd'] = '修改密码';
$_LANG['fcm_tool'] = '防沉迷应急工具';
$_LANG['export_detail'] = '导出充值明细';
$_LANG['search_card'] = '卡片查询';



/*补偿仓库*/

$_LANG['compensation_other']='其他';
$_LANG['compensation_pet']='宠物补偿';
$_LANG['compensation_item']='道具补偿';
$_LANG['item_edit'] = '道具修改';
$_LANG['pet_edit'] = '宠物修改';
...
/* 系统设置 */
$_LANG['set_config'] = '系统设置';
$_LANG['admin_login'] = '后台登陆';
$_LANG['view_all'] = '查看所有可跳转平台';
...
$_LANG['clear_ver'] = '清除客户端缓存文件';
$_LANG['push_all'] = '推送配置文件';
$_LANG['logs_manage'] = '管理员日志列表';
$_LANG['sqltool'] = 'SQL工具';
$_LANG['clear_log'] = '删除管理员日志';
$_LANG['set_payment'] = '充值活动设置';
