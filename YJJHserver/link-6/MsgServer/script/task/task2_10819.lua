...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",37) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",37) == true)then		      --判断任务步骤
...
function npcAct3()
--	Hero:ActFun(1080,"task new 2",37)
  Hero:ActFun(1080,"task accept 2",37)
  result=true;
end
...
if(gContext==110819)then	
  npcAct1()
elseif(gContext==110820)then
  npcAct2()
 elseif(gContext==110821)then
  npcAct3()
elseif(gContext==110832)then
  npcAct4()
end
