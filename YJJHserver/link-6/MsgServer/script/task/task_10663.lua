...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",82) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",82) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",82) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 3",82)				          --设置任务状态为1
      else
      ...
      Hero:ActFun(127,"已经完成了任务",0)  	 	                              --显示系统文字
		...
		Hero:ActFun(1080,"task new 3",82)
    Hero:ActFun(1080,"task accept 3",82)				              --设置任务状态为1
  end
end
  ...
  elseif(Hero:ActFun(1080,"task has 0",82) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",82) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",82) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 3",82)				            --设置第一步状态为完成
        Hero:ActFun(1080,"task delete 3",82)	
        Hero:ActFun(1080,"daymask += 4",82)	
				Hero:ActFun(1001,"exp += 42000",0)
...
if(gContext==3010663)then	
  npcAct1()
elseif(gContext==3010664)then
  npcAct2()
elseif(gContext==3010665)then
  npcAct3()
end
