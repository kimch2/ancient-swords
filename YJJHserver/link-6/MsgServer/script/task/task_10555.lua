...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",19) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 3",19) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",19) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 3",19)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",19) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",19) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 3",19)				--设置第一步状态为完成
      --Hero:ActFun(1080,"step += 1",19)				--设置任务步骤数加1
      Hero:ActFun(1080,"task delete 3",19)		--删除任务
Hero:ActFun(1080,"mask += 19",19)			--任务结束，加掩码
