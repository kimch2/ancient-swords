...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",92) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",92) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",92) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 2",92)				          --设置任务状态为1
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",92) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",92) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",92) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 2",92)				            --设置第一步状态为完成
        Hero:ActFun(1080,"step += 1",92)
				Hero:ActFun(1001,"exp += 46800",0)
				Hero:ActFun(1001,"money += 3600",2)
				Hero:ActFun(498,"0",620041)
				Hero:ActFun(1046,"92 3",3)	
...
if(gContext==3010744)then	
  npcAct1()
elseif(gContext==3010745)then
  npcAct2()
elseif(gContext==3010746)then
  npcAct3()
end
