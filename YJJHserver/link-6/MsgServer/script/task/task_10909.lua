...
function npcAct1()
    ...
    if(Hero:ActFun(1050,"1",626100) == false)then		      --判断任务步骤
    	Hero:ActFun(1080,"step = 4",29)
    	Hero:ActFun(1080,"task accept 4",29)				          --设置任务状态为1
    	Hero:ActFun(519,"1 1",626100)
    else
    	Hero:ActFun(127,"你有未完成的跑商任务",0)  	 	                              --显示系统文字
    end
  else
  	Hero:ActFun(1080,"task new 4",29)
    Hero:ActFun(1080,"task accept 4",29)				              --设置任务状态为1
    Hero:ActFun(519,"1 1",626100)
  end
end
...
function npcAct2()
	if(Hero:ActFun(1014,"",0) == true)then
		Hero:ActFun(1080,"task end 4",29)
		Hero:ActFun(1080,"step = 4",29)
...
if(gContext==3010909)then
  npcAct1()
elseif(gContext==3010910)then
  npcAct2()
elseif(gContext==3010911)then
  npcAct3()
end
