...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 28",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",145004) == true)then
		Hero:ActFun(1080,"task end 28",10001)
...
if(gContext==3020082)then	
  npcAct1()
elseif(gContext==3020083)then
  npcAct2()
elseif(gContext==3020084)then
  npcAct3()
end
