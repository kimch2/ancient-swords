...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 124",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",220004) == true)then
		Hero:ActFun(1080,"task end 124",10001)
...
if(gContext==3020370)then	
  npcAct1()
elseif(gContext==3020371)then
  npcAct2()
elseif(gContext==3020372)then
  npcAct3()
end
