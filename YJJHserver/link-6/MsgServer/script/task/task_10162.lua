	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
		...
		if(Hero:ActFun(1080,"step == 7",3) == true)then				--判断任务步骤
	  		...
	  		if(Hero:ActFun(1080,"task state 0",3) == true)then				--判断任务状态
				 	--Hero:ActFun(1046,"7",27)       --答题7
			 	  Hero:ActFun(1080,"task accept 7",3)				--设置任务状态为1
			  else
	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
	    ...
	    --判断任务是否已完成，已完成则进入下一步
	  	...
	  	elseif(Hero:ActFun(1080,"task state 3",3) == true)then				--判断任务状态
	       Hero:ActFun(1080,"task end 7",3)				--设置第一步状态为完成
...
function npcAct4()
	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then					--判断任务链是否建立，建立则进入下一步
 	 Hero:ActFun(1080,"step = 8",3)					 --设置此步骤为0
	else
 	 Hero:ActFun(127,"未接受任务",0)					 --显示系统文字
	end
...
function npcAct5()
	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
	 	...
	 	if(Hero:ActFun(1080,"step == 8",3) == true)then				--判断任务步骤
