...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 121",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",210003) == true)then
		Hero:ActFun(1080,"task end 121",10001)
...
if(gContext==3020361)then	
  npcAct1()
elseif(gContext==3020362)then
  npcAct2()
elseif(gContext==3020363)then
  npcAct3()
end
