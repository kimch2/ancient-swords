...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 1",5) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",5) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 1",5)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",5) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 1",5)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",5)				--设置任务步骤数加1
      Hero:ActFun(498,"0",620009)
      Hero:ActFun(1001,"exp += 16000",0)			--给经验
      --Hero:ActFun(1001,"petexp += 8000",0)			--给宠物经验
	     Hero:ActFun(1001,"money += 3200",2)
...
if(gContext==3010219)then
  npcAct1()
elseif(gContext==3010220)then
  npcAct2()
elseif(gContext==3010221)then
  npcAct3()
end
