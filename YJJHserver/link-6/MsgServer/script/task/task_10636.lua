  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 28",1) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",1) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 28",1)				          --设置任务状态为1
        Hero:ActFun(1046,"32",28)	
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 28",1) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",1) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 28",1)				            --设置第一步状态为完成
...
if(gContext==3010636)then
  npcAct1()
elseif(gContext==3010637)then
  npcAct2()
elseif(gContext==3010638)then
  npcAct3()
end
