...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 103",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",145009) == true)then
		Hero:ActFun(1080,"task end 103",10001)
...
if(gContext==3020307)then	
  npcAct1()
elseif(gContext==3020308)then
  npcAct2()
elseif(gContext==3020309)then
  npcAct3()
end
