...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",6) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 5",6) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",6) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 5",6)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",6) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",6) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 5",6)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",6)				--设置任务步骤数加1
      Hero:ActFun(1001,"exp += 40000",0)			--给经验
      --Hero:ActFun(1001,"petexp += 20000",0)			--给宠物经验
	     Hero:ActFun(1001,"money += 2704",2)
      Hero:ActFun(498,"0",620010)
...
if(gContext==3010294)then
  npcAct1()
elseif(gContext==3010295)then
  npcAct2()
elseif(gContext==3010296)then
  npcAct3()
end
