...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",41) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 2",41) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",41) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 2",41)				  --设置任务状态为1
      else
  	...
  	Hero:ActFun(1080,"task new 2",41)
    Hero:ActFun(1080,"task accept 2",41)				--设置任务状态为1
  end
end
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",41) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",41) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 2",41)				--设置第一步状态为完成
      --Hero:ActFun(1080,"task delete 2",41)
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",41) == true)then
    Hero:ActFun(1080,"step = 2",41)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3110951)then
  npcAct1()
elseif(gContext==3110952)then
  npcAct2()
elseif(gContext==3110953)then
  npcAct3()
end
