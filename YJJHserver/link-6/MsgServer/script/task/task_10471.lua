...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",10) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 10",10) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",10) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 10",10)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",10) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",10) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 10",10)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",10)				--设置任务步骤数加1
      Hero:ActFun(498,"0",620026)
...
if(gContext==3010471)then
  npcAct1()
elseif(gContext==3010472)then
  npcAct2()
elseif(gContext==3010473)then
  npcAct3()
end
