...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 62",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
		Hero:ActFun(1080,"task end 62",10001)
...
Hero:ActFun(1080,"task endnogive 62",10001)
...
if(gContext==3020184)then	
  npcAct1()
elseif(gContext==3020185)then
  npcAct2()
elseif(gContext==3020186)then
  npcAct3()
end
