...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",11) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 6",11) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",11) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 6",11)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",11) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",11) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 6",11)				--设置第一步状态为完成
      --Hero:ActFun(1080,"step += 1",11)				--设置任务步骤数加1
      Hero:ActFun(1080,"task delete 6",11)		--删除任务
Hero:ActFun(1080,"mask += 11",11)
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",11) == true)then
    Hero:ActFun(1080,"step = 6",11)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010501)then
  npcAct1()
elseif(gContext==3010502)then
  npcAct2()
elseif(gContext==3010503)then
  npcAct3()
end
