...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 27",1) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",1) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 27",1)				          --设置任务状态为1
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 27",1) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",1) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 27",1)				            --设置第一步状态为完成
        Hero:ActFun(1080,"step += 1",1)				                      --设置任务步骤数加1
        Hero:ActFun(1001,"exp += 1000",0)			--给经验
        Hero:ActFun(1001,"money += 5000",2)
        Hero:ActFun(1046,"1 28",3)				                      --自动接下一个
...
if(gContext==3010633)then
  npcAct1()
elseif(gContext==3010634)then
  npcAct2()
elseif(gContext==3010635)then
  npcAct3()
end
