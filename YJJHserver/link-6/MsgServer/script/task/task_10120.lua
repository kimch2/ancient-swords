...
function npcAct1()
	...
	elseif(Hero:ActFun(1080,"task has 0",2) == true)then				--判断任务链
		...
		if(Hero:ActFun(1080,"step == 4",2) == true)then				--判断任务步骤


	  	if(Hero:ActFun(1080,"task state 0",2) == true)then				--判断任务状态

			
			 Hero:ActFun(1080,"task accept 4",2)				--设置任务状态为1
			else
...
function npcAct2()
	...
	elseif(Hero:ActFun(1080,"task has 0",2) == true)then				--判断任务链
	    ...
	    --判断任务是否已完成，已完成则进入下一步
	     ...
	     Hero:ActFun(1080,"task end 4",2)				--设置第一步状态为完成
	     ...
	     Hero:ActFun(1001,"money += 1200",2)			--给碎银
	     Hero:ActFun(1046,"2 5",3)					     --马上接取下一个
	     if(Hero:ActFun(1080,"mask == 28",28) == false)then
	     Hero:ActFun(1080,"task new 1",28)				--建立此任务
			 Hero:ActFun(1080,"task accept 1",28)				--设置任务状态为1
			 end
...
function npcAct3()
	...
	elseif(Hero:ActFun(1080,"task has 0",2) == true)then					--判断任务链是否建立，建立则进入下一步
 	 Hero:ActFun(1080,"step = 4",2)					 --设置此步骤为0
 	 Hero:ActFun(498,"0",620008)
	else
 	 Hero:ActFun(127,"未接受任务",0)					 --显示系统文字
	end
