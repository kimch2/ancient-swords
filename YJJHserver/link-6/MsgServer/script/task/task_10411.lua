...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",9) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 10",9) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",9) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 10",9)				  --设置任务状态为1
      else
...
if(gContext==3010411)then
  npcAct1()
elseif(gContext==3010412)then
  npcAct2()
elseif(gContext==3010413)then
  npcAct3()
end
