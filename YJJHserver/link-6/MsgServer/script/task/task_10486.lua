...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",11) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 1",11) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",11) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 1",11)				  --设置任务状态为1
      else
  	...
  	Hero:ActFun(1080,"task new 1",11)
    Hero:ActFun(1080,"task accept 1",11)				--设置任务状态为1
  end
end
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",11) == true)then				--判断任务链
    ...
    if(Hero:ActFun(508,"47 1",0) == true)then
      Hero:ActFun(1080,"task end 1",11)				--设置第一步状态为完成
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",11) == true)then
    Hero:ActFun(1080,"step = 1",11)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010486)then
  npcAct1()
elseif(gContext==3010487)then
  npcAct2()
elseif(gContext==3010488)then
  npcAct3()
end
