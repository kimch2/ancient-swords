...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 2",4) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",4) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 2",4)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",4) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 2",4)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",4)				--设置任务步骤数加1
      Hero:ActFun(1001,"exp += 6000",0)			--给经验
      --Hero:ActFun(1001,"petexp += 3000",0)			--给宠物经验
	     Hero:ActFun(1001,"money += 1800",2)			--给碎银
      Hero:ActFun(1046,"4 3",3)					     --马上接取下一个
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then
    Hero:ActFun(1080,"step = 2",4)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010186)then
  npcAct1()
elseif(gContext==3010187)then
  npcAct2()
elseif(gContext==3010188)then
  npcAct3()
end
