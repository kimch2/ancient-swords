...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 75",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
		Hero:ActFun(1080,"task end 75",10001)
...
if(gContext==3020223)then	
  npcAct1()
elseif(gContext==3020224)then
  npcAct2()
elseif(gContext==3020225)then
  npcAct3()
end
