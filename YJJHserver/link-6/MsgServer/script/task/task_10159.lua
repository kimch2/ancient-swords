...
function npcAct1()
	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
		...
		if(Hero:ActFun(1080,"step == 6",3) == true)then				--判断任务步骤
		

	  	if(Hero:ActFun(1080,"task state 0",3) == true)then				--判断任务状态
			
			
			 Hero:ActFun(1080,"task accept 6",3)				--设置任务状态为1
	     ...
	     Hero:ActFun(127,"任务已经完成了",0)				--显示系统文字
	  	...
	  	elseif(Hero:ActFun(1080,"task state 3",3) == true)then				--判断任务状态
	  		if(Hero:ActFun(508,"47 1",0) == true)then
	     		Hero:ActFun(1080,"task end 6",3)				--设置第一步状态为完成
			...
			Hero:ActFun(498,"0",620090)
  	   		...
  	   		Hero:ActFun(1046,"3 7",3)					     --马上接取下一个，暂时不用
  			else
