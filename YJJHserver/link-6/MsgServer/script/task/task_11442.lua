...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",35) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",35) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",35) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 2",35)				          --设置任务状态为1
  ...
  elseif(Hero:ActFun(1080,"task has 0",35) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",35) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",35) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 2",35)				            --设置第一步状态为完成
        --Hero:ActFun(1080,"step += 1",35)
        Hero:ActFun(1080,"task delete 2",35)
...
if(gContext==3011442)then	
  npcAct1()
elseif(gContext==3011443)then
  npcAct2()
elseif(gContext==3011444)then
  npcAct3()
end
