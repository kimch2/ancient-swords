...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 12",4) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",4) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 12",4)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",4) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 12",4)				--设置第一步状态为完成
      Hero:ActFun(1080,"task delete 12",4)		--删除任务
Hero:ActFun(1080,"mask += 4",4)	
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then
    Hero:ActFun(1080,"step = 12",4)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010216)then
  npcAct1()
elseif(gContext==3010217)then
  npcAct2()
elseif(gContext==3010218)then
  npcAct3()
end
