...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",36) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",36) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",36) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 2",36)				          --设置任务状态为1
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",36) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",36) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",36) == true)then				--判断任务状态
        	...
        	Hero:ActFun(1080,"task end 2",36)				            --设置第一步状态为完成
...
if(gContext==3010807)then	
  npcAct1()
elseif(gContext==3010808)then
  npcAct2()
elseif(gContext==3010809)then
  npcAct3()
end
