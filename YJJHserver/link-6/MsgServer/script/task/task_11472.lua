...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",35) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 12",35) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",35) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 12",35)				          --设置任务状态为1
      ...
      Hero:ActFun(127,"已经完成了任务",0)  	 	                              --显示系统文字
		...
		--Hero:ActFun(1080,"task new 12",35)
    Hero:ActFun(1080,"task accept 12",35)				              --设置任务状态为1
    Hero:ActFun(1046,"16",23)
        Hero:ActFun(1046,"45",28)
  end
  ...
  elseif(Hero:ActFun(1080,"task has 0",35) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 12",35) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",35) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 12",35)				            --设置第一步状态为完成
        --Hero:ActFun(1080,"step += 1",35)
        Hero:ActFun(1080,"task delete 12",35)
...
if(gContext==3011472)then	
  npcAct1()
elseif(gContext==3011473)then
  npcAct2()
elseif(gContext==3011474)then
  npcAct3()
end
