...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",89) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",89) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",89) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 3",89)				          --设置任务状态为1
      else
      ...
      Hero:ActFun(127,"已经完成了任务",0)  	 	                              --显示系统文字
		...
		Hero:ActFun(1080,"task new 3",89)
    Hero:ActFun(1080,"task accept 3",89)				              --设置任务状态为1
  end
end
  ...
  elseif(Hero:ActFun(1080,"task has 0",89) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",89) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",89) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 3",89)				            --设置第一步状态为完成
        Hero:ActFun(1080,"task delete 3",89)	
...
if(gContext==3010726)then	
  npcAct1()
elseif(gContext==3010727)then
  npcAct2()
elseif(gContext==3010728)then
  npcAct3()
end
