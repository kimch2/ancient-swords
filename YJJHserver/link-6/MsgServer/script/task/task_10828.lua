	    ...
	    if(Hero:ActFun(1102,"countfemale == 1",0) == true)then		      --判断男女各1
	      if(Hero:ActFun(1102,"countmale == 1",0) == true)then				    --判断男女各1
	      	if(Hero:ActFun(1102,"active 0 0",0) == true)then
	       			...
	       			if(Hero:ActFun(1116,"",110828)== true)then
	       				Hero:ActFun(1116,"",110830)
	       			else
	  ...
	  if(Hero:ActFun(1102,"count == 2",0) == true)then				      --判断队伍2人
	    if(Hero:ActFun(1102,"countfemale == 1",0) == true)then		      --判断男女各1
	      if(Hero:ActFun(1102,"countmale == 1",0) == true)then				    --判断男女各1
	      	if(Hero:ActFun(1102,"active 0 0",0) == true)then
						if(Hero:ActFun(1102,"teamlead 0 0",0) == true)then
	       			if(Hero:ActFun(1116,"",110829)== true)then
	       				if(Hero:ActFun(1116,"",110836)== true)then
	       					Hero:ActFun(1116,"",110835)
	       				else
	       					Hero:ActFun(1116,"",110838)
	       				end
	       			else
	       				Hero:ActFun(1116,"",110837)
	       			end
  ...
  elseif(Hero:ActFun(1080,"task has 0",37) == true)then
    ...
    --Hero:ActFun(498,"0",620049)
	 ...
	 -- Hero:ActFun(1080,"task delete 4",37)				--设置第一步状态为完成
	    Hero:ActFun(1080,"task end 5",37)				--设置第一步状态为完成
	    Hero:ActFun(1080,"task delete 5",37)				--设置第一步状态为完成
...
if(gContext==3010828)then
  npcAct1()
elseif(gContext==3010829)then
  npcAct2()
elseif(gContext==3010830)then
  npcAct3()
end
