...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 29",1) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",1) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 29",1)				          --设置任务状态为1
      else
...
if(gContext==3010639)then
  npcAct1()
elseif(gContext==3010640)then
  npcAct2()
elseif(gContext==3010641)then
  npcAct3()
end
