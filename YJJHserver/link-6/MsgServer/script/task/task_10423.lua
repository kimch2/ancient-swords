...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",9) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 14",9) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",9) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 14",9)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",9) == true)then				--判断任务链
    ...
    if(Hero:ActFun(508,"47 1",0) == true)then
      Hero:ActFun(1080,"task end 14",9)				--设置第一步状态为完成
      ...
      --Hero:ActFun(1001,"petexp += 100000",0)			--给宠物经验
	     ...
	     Hero:ActFun(519,"1 1",170904)
      Hero:ActFun(1046,"9 15",3)
      else
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",9) == true)then
    Hero:ActFun(1080,"step = 14",9)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010423)then
  npcAct1()
elseif(gContext==3010424)then
  npcAct2()
elseif(gContext==3010425)then
  npcAct3()
end
