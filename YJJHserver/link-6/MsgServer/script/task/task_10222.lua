...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 2",5) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",5) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 2",5)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",5) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 2",5)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",5)				--设置任务步骤数加1
      Hero:ActFun(498,"0",620016)
...
if(gContext==3010222)then
  npcAct1()
elseif(gContext==3010223)then
  npcAct2()
elseif(gContext==3010224)then
  npcAct3()
end
