...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 85",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",142008) == true)then
		Hero:ActFun(1080,"task end 85",10001)
...
if(gContext==3020253)then	
  npcAct1()
elseif(gContext==3020254)then
  npcAct2()
elseif(gContext==3020255)then
  npcAct3()
end
