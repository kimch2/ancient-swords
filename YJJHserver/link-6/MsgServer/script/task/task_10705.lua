...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",87) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",87) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",87) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 2",87)				          --设置任务状态为1
      else
      ...
      Hero:ActFun(127,"已经完成了任务",0)  	 	                              --显示系统文字
		...
		Hero:ActFun(1080,"task new 2",87)
    Hero:ActFun(1080,"task accept 2",87)				              --设置任务状态为1
  end
end
  ...
  elseif(Hero:ActFun(1080,"task has 0",87) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",87) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",87) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 2",87)				            --设置第一步状态为完成
        Hero:ActFun(1080,"step += 1",87)
				Hero:ActFun(1001,"exp += 35400",0)
				Hero:ActFun(1001,"money += 2400",2)
				Hero:ActFun(498,"0",620037)
				Hero:ActFun(1046,"87 3",3)	
...
if(gContext==3010705)then	
  npcAct1()
elseif(gContext==3010706)then
  npcAct2()
elseif(gContext==3010707)then
  npcAct3()
end
