--表头
function npctop1()
  Hero:ActFun(101,"&&<0_帮业中兴，不在朝夕而在长远，年轻人，你来找我，是想为帮派出力么？>",0)
end
...
--功能选项
function npcmid10()
  --Hero:ActFun(102,"[44]领取帮派任务 2904601",0)
end

function npcmid11()
  --Hero:ActFun(102,"[22]完成帮派任务 2904602",0)
end
function npcmid12()
   Hero:ActFun(102,"[6]兑换归元心经 2904603",0)
end
function npcmid13()
   --Hero:ActFun(102,"[1]领取聚义酒 2904604",0)
end
function npcmid14()
   Hero:ActFun(102,"[1]传出帮派 2904606",0)
end
function npcmid15()
   --Hero:ActFun(102,"[1]召唤帮敌 1011",0)  转到PB01中
end
function npcmid16()
  --Hero:ActFun(102,"[3]帮派历练场 2904605",0)
end
--转向选项
function npctask4()
  if(Hero:ActFun(503,"5",630031))then
	   if(Hero:ActFun(508,"47 1",0) == true)then
	     if(Hero:ActFun(498,"5",630031) == true)then
		  Hero:ActFun(519,"1 1",591000)
		  --Hero:ActFun(498,"5",630031)
		end
		else
		Hero:ActFun(127,"兑换需要1格道具栏空位",0)
		end

	else
	Hero:ActFun(127,"您携带的归元心经残页不足，5个归元心经残页才能兑换归元心经",0)
	end
end

 function npctask5()
if(Hero:ActFun(1001,"level > 0",0) == true)then
    if(Hero:ActFun(1080,"daymask == 50",1) == false)then
        if(Hero:ActFun(1001,"Syncon > 49",0) == true)then
            if(Hero:ActFun(508,"47 1",0) == true)then
             --if(Syngrow > 2)then
             Hero:ActFun(1001,"Syncon -= 50",0)  --扣帮贡
             -- Hero:ActFun(1001,"Syngrow   -= 2",0)  --扣建设度
             Hero:ActFun(519,"1 1",501034)
             Hero:ActFun(1080,"daymask += 50",1)
			else
			Hero:ActFun(127,"领取聚义酒需要1个道具栏空位，请先清理背包",0)
			end
        else
            Hero:ActFun(127,"领取聚义酒需要50帮贡，你帮贡不够",0)
	    end
	else
      Hero:ActFun(127,"你今天已经领取过聚义酒，明天再来吧",0)
	end
 else
    Hero:ActFun(127,"你等级不够，不能领取聚义酒",0)
 end
 end

 function npctask6()

 Hero:LeaveSynMap() --传出地图
 end
function npctask7()
...
--npcmid13()
--npcmid15()
 --if(Hero:ActFun(1080,"step = 209",20001) == true or Hero:ActFun(1080,"step = 210",20001) == true or Hero:ActFun(1080,"step = 211",20001) == true or Hero:ActFun(1080,"step = 212",20001) == true or Hero:ActFun(1080,"step = 213",20001) == true or Hero:ActFun(1080,"step = 214",20001) == true or Hero:ActFun(1080,"step = 215",20001) == true or Hero:ActFun(1080,"step = 216",20001) == true)then
 -- npcmid16()
 --end
if(Hero:ActFun(1080,"task state 1",20001) == true)then
	...
	--if(Hero:ActFun(1080,"task state 3",20001) == true)then
		--	npcmid11()
		--if(Hero:ActFun(1080,"task state 2",20001) == true)then
			--npcmid10()
			--end
	  -- else
	   -- if(Hero:ActFun(1080,"task has 0",20001) == true)then		--天掩码判定，未关闭
...
elseif(gContext==2904601)then
 npctask1()
elseif(gContext==2904602)then
 npctask2()
elseif(gContext==2904603)then
 npctask4()
elseif(gContext==2904604)then
 npctask5()
 elseif(gContext==2904606)then
 npctask6()
 elseif(gContext==2904605)then
 npctask7()
end
