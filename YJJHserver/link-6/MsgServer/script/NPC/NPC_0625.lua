...
--功能选项
function npcmid10()
  Hero:ActFun(102,"[1]恢复--免费 2062501",0)
end

function npcmid101()
  Hero:ActFun(102,"[1]恢复--1银 2062502",0)
end

function npcmid102()
  Hero:ActFun(102,"[1]恢复--3银 2062503",0)
end

function npcmid103()
  Hero:ActFun(102,"[1]恢复--5银 2062504",0)
end

function npcmid104()
  Hero:ActFun(102,"[1]恢复--8银 2062505",0)
end

function npcmid105()
  Hero:ActFun(102,"[1]恢复--12银 2062506",0)
end

function npcmid106()
  Hero:ActFun(102,"[1]恢复--15银 2062507",0)
end

function npcmid107()
  Hero:ActFun(102,"[1]恢复--18银 2062508",0)
end

function npcmid108()
  Hero:ActFun(102,"[1]恢复--20银 2062509",0)
end

function npcmid109()
  Hero:ActFun(102,"[1]恢复--25银 2062510",0)
end
