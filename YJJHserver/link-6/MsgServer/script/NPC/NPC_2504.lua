--表头	
function npctop1()  
  Hero:ActFun(101,"&&<0_若想加入少林派的话，可以去找掌门方丈玄慈。>",0)
  Hero:ActFun(101,"<br>&&<0_加入少林后，可以向大师兄玄常学习战斗技能。>",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[5]江陵 2250401",0)
end

function npcmid11()
  Hero:ActFun(102,"[5]开封 2250402",0)
end

function npcmid12()
  Hero:ActFun(102,"[22]回访洛神 2250403",0)
end
--表尾
function npcTail()
  Hero:ActFun(103,"",0)
...
--显示表头
 ...
 if(Hero:ActFun(1080,"mask == 1",1) == false)then				--判断掩码
		...
		if(Hero:ActFun(1080,"task has 0",1) == true)then				--判断任务链
			...
			if(Hero:ActFun(1080,"step == 26",1) == true)then				--判断任务步骤
...
npcmid11()
 ...
 --显示表尾
 npcTail()
elseif(gContext==2250401)then
 npctask1()
elseif(gContext==2250402)then
 npctask2()
elseif(gContext==2250403)then
 npctask3()
end