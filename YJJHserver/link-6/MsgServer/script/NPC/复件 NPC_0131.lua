--表头	
function npctop1()  
  Hero:ActFun(101,"和神医同名不是我的错，为大侠你治病可是我的拿手绝活。",0)
end
...
function npcmid034010()
  Hero:ActFun(102,"[4]最美味的山猪肉（1） 2013111",0)  --接任务
end
...
function npcmid034012()
  Hero:ActFun(102,"[2]最美味的山猪肉（1） 2013111",0)  --交任务
end

--任务3402 
function npcmid034020()
  Hero:ActFun(102,"[4]最美味的山猪肉（2） 2013113",0)  --接任务
end
...
function npcmid034022()
  Hero:ActFun(102,"[2]最美味的山猪肉（2） 2013113",0)  --交任务
end
...
if(Hero:ActFun(1001,"level < 11",1)==true)then
  ...
  elseif(Hero:ActFun(1001,"level < 91",1)==true)then
	 npcmid108()
  elseif(Hero:ActFun(1001,"level < 101",1)==true)then
	 npcmid109()
end
