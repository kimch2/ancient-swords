...
function npcmid03041()
  Hero:ActFun(102,"[22]领取宠物 2010802",0)

end
function npcmid03042()
  Hero:ActFun(102,"[44]回复洛神 2010803",0)

end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[6]饲料商店 2010801",0)
  --Hero:ActFun(102,"[1]兑换延年丹 2010804",0)
end
...
--显示表尾
 npcTail()
elseif(gContext==2010801)then
 npctask1()
elseif(gContext==2010802)then
 npctask2()
elseif(gContext==2010803)then
 npctask3()
elseif(gContext==2010804)then
 npctask4()
end
