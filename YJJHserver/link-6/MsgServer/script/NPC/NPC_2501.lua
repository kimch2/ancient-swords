--表头
function npctop1()
  Hero:ActFun(101,"&&<0_六根皆静，四大皆空。>",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[44]领取师门任务 2250105",0)
end

function npcmid11()
  Hero:ActFun(102,"[7]门派介绍 2250101",0)
end

function npcmid101()
  Hero:ActFun(102,"[22]交师门任务 2250106",0)
end

function npcmid1031()
  Hero:ActFun(102,"[22]拜入少林，成为少林弟子 2250102",0)
end

function npcmid1033()
  Hero:ActFun(102,"[1]加入第二门派 2250104",0)
end

function npcmid1032()
  Hero:ActFun(102,"[1]切换主副职业 2250103",0)
end

function npcmid1034()
  Hero:ActFun(102,"[1]兑换师门称号 2250108",0)
end
function npcmid1035()
  Hero:ActFun(102,"[22]帮派拜访 2250113",0)
end
--表尾
function npcTail()
  Hero:ActFun(103,"",0)
...
--转向选项1
function npctask1()
	Hero:ActFun(101,"&&<0_少林位于少室山，有“禅宗祖廷，天下第一名刹”之誉。><br>&&<0_少室山处中原腹地，>",0)
	Hero:ActFun(101,"<0_紧傍古都江陵，盛世时，少室山是帝王游赏、文士登临的胜地；>",0)
	Hero:ActFun(101,"<0_乱世时，少室山则是兵家出入、强人会集的所在。少林弟子皆入佛门，>",0)
...
--转向选项3
function npctask3()
	if(Hero:ActFun(1096,"== 16",1) == false)then
		if(Hero:ActFun(1096,"== 16",2) == true)then
...
function npctask2()
  	...
  	Hero:ActFun(1080,"task end 23",1)
  	Hero:ActFun(1080,"step += 1",1)
  	Hero:ActFun(1080,"task accept 24",1)
...
function npctask4()
	if(Hero:ActFun(1001,"level >= 45",0) == true)then				--判断人物等级
		if(Hero:ActFun(1096,"== 16",1) == false)then				--判断主职业是否少林
			if(Hero:ActFun(1096,"== 16",2) == false)then				--判断副职业是否峨眉
				...
				Hero:ActFun(127,"你已经是少林弟子",0)
			end
		else
			Hero:ActFun(127,"你已经是少林弟子",0)
		end
	else
	Hero:ActFun(127,"你的等级不够45级，无法加入副职业",0)
	end
end

--转向选项5
function npctask5()
	if(Hero:ActFun(1001,"Profession == 16",0) == true)then
...
function npctask8()
	...
	Hero:ActFun(102,"[1]【静心僧人】500点师门贡献 2250109",0)
	Hero:ActFun(102,"[1]【得道高僧】1000点师门贡献 2250110",0)
	Hero:ActFun(102,"[1]【少林方丈】3000点师门贡献 2250111",0)
	Hero:ActFun(102,"[1]【伏魔金刚】5000点师门贡献 2250112",0)
	Hero:ActFun(103,"",0)
end

function npctask9()
	if(Hero:ActFun(1001,"Profession == 16",0) == true)then							--判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4005",0) == true)then				--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 1",4005) == true)then			--已有的称号大于1级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于1级
				if(Hero:ActFun(1001,"jobcon > 499",0) == true)then						--判断贡献度是否达到500
					Hero:ActFun(1001,"jobcon -= 500",0)
					Hero:ActFun(1001,"userholdtitle = 1",4005)									--把已有称号设为1级
				else																													--贡献度不足
		...
		if(Hero:ActFun(1001,"jobcon > 499",0) == true)then								--判断贡献度是否达到500
			Hero:ActFun(1001,"jobcon -= 500",0)
			Hero:ActFun(1001,"userholdtitle += 4005",1)											--增加1级门派称号
		else																															--贡献度不足
			Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
		end
	end
	else
		Hero:ActFun(127,"只有少林弟子可以获得本派师门称号。",0)
	end
end
...
function npctask10()
	if(Hero:ActFun(1001,"Profession == 16",0) == true)then							--判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4005",0) == true)then				--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 2",4005) == true)then			--已有的称号大于2级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于2级
				if(Hero:ActFun(1001,"jobcon > 999",0) == true)then						--判断贡献度是否达到1000
					Hero:ActFun(1001,"jobcon -= 1000",0)
					Hero:ActFun(1001,"userholdtitle = 2",4005)									--把已有称号设为2级
				else																													--贡献度不足
					Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 999",0) == true)then							--判断贡献度是否达到1000
				Hero:ActFun(1001,"jobcon -= 1000",0)
				Hero:ActFun(1001,"userholdtitle += 4005",2)										--增加1级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask11()
	if(Hero:ActFun(1001,"Profession == 16",0) == true)then              --判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4005",0) == true)then     	--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 3",4005) == true)then 		--已有的称号大于3级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于3级
				if(Hero:ActFun(1001,"jobcon > 2999",0) == true)then						--判断贡献度是否达到3000
					Hero:ActFun(1001,"jobcon -= 3000",0)
					Hero:ActFun(1001,"userholdtitle = 3",4005)									--把已有称号设为3级
				else																													--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 2999",0) == true)then        			--判断贡献度是否达到3000
				Hero:ActFun(1001,"jobcon -= 3000",0)
				Hero:ActFun(1001,"userholdtitle += 4005",3)         					--增加3级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask12()
	if(Hero:ActFun(1001,"Profession == 16",0) == true)then              --判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4005",0) == true)then     	--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 4",4005) == true)then 		--已有的称号大于等于4级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于4级
				if(Hero:ActFun(1001,"jobcon > 4999",0) == true)then  					--判断贡献度是否达到5000
					Hero:ActFun(1001,"jobcon -= 5000",0)
					Hero:ActFun(1001,"userholdtitle = 4",4005)									--把已有称号设为4级
				else																													--贡献度不足
					Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 4999",0) == true)then        			--判断贡献度是否达到5000
				Hero:ActFun(1001,"jobcon -= 5000",0)
				Hero:ActFun(1001,"userholdtitle += 4005",4)         					--增加4级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask13()
if(Hero:ActFun(1080,"step == 166",20001) == true)then
...
if(Hero:ActFun(1080,"step == 166",20001) == true)then
 ...
 --显示表尾
 npcTail()
elseif(gContext==2250101)then
 npctask1()
 elseif(gContext==2250102)then
 npctask2()
 elseif(gContext==2250103)then
 npctask3()
  elseif(gContext==2250104)then
 npctask4()
elseif(gContext==2250105)then
 npctask5()
elseif(gContext==2250106)then
 npctask6()
elseif(gContext==2250107)then
 npctask7()
elseif(gContext==2250108)then
npctask8()
elseif(gContext==2250109)then
npctask9()
elseif(gContext==2250110)then
npctask10()
elseif(gContext==2250111)then
npctask11()
elseif(gContext==2250112)then
npctask12()
elseif(gContext==2250113)then
npctask13()
end
