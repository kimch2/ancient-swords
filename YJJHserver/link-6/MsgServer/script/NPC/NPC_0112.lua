...
function npcmid03071()
  Hero:ActFun(102,"[22]领取药品 2011202",0)
end

function npcmid03072()
  Hero:ActFun(102,"[44]回复张择端 2011203",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[6]药品店 2011201",0)
end
...
npcmid10()
 --显示表尾
npcTail()
elseif(gContext==2011201)then
 npctask1()
elseif(gContext==2011202)then
 npctask2()
elseif(gContext==2011203)then
 npctask3()
end
