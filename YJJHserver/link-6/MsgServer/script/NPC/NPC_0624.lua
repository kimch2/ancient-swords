--表头	
function npctop1()  
  Hero:ActFun(101,"&&<0_和草药同名不是我的错，为大侠你治病可是我的拿手绝活。>",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[1]恢复--免费 2062401",0)
end

function npcmid101()
  Hero:ActFun(102,"[1]恢复--1银 2062402",0)
end

function npcmid102()
  Hero:ActFun(102,"[1]恢复--3银 2062403",0)
end

function npcmid103()
  Hero:ActFun(102,"[1]恢复--5银 2062404",0)
end

function npcmid104()
  Hero:ActFun(102,"[1]恢复--8银 2062405",0)
end

function npcmid105()
  Hero:ActFun(102,"[1]恢复--12银 2062406",0)
end

function npcmid106()
  Hero:ActFun(102,"[1]恢复--15银 2062407",0)
end

function npcmid107()
  Hero:ActFun(102,"[1]恢复--18银 2062408",0)
end

function npcmid108()
  Hero:ActFun(102,"[1]恢复--20银 2062409",0)
end

function npcmid109()
  Hero:ActFun(102,"[1]恢复--25银 2062410",0)
end
