...
--任务101接受
function npcmid1010()
  Hero:ActFun(102,"[1]举行出师仪式 2011713",0)
end
--任务102接受
function npcmid2010()
  Hero:ActFun(102,"[1]我带徒弟来解除关系 2011711",0)
end
--任务103接受
function npcmid3010()
  Hero:ActFun(102,"[1]我要叛出师门 2011712",0)
end
--任务104接受
function npcmid4010()
  Hero:ActFun(102,"[1]我要踢出徒弟 2011709",0)
end
...
--任务105接受
function npcmid5010()
  Hero:ActFun(102,"[42]师徒任务-传道 2011705",0)
end
--任务106接受
function npcmid6010()
  Hero:ActFun(102,"[42]师徒任务-解惑 2011706",0)
end
...
--任务107接受
function npcmid7010()
  Hero:ActFun(102,"[44]师徒任务-授业 2011707",0)
end
--任务107未完成
function npcmid7011()
  Hero:ActFun(102,"[3]师徒任务-授业 2011708",0)
end
--任务107已完成
function npcmid7012()
  Hero:ActFun(102,"[22]师徒任务-授业 2011707",0)
end
...
--任务108接受
function npcmid8010()
   Hero:ActFun(102,"[1]我带人来结成师徒关系 2011714",0)
end
        ...
        if(Hero:ActFun(1102,"teamlead 0 0 ",0) == true)then
                  if(Hero:ActFun(1102,"count == 2",0) == true)then
                           if(Hero:ActFun(750,"",0) == true)then                   --判断是否是师徒关系
                                     ...
                                     if(Hero:ActFun(752,"",0) == true)then         --协议解除师徒关系,向A(师傅)确认是否解除师徒关系
...
elseif(gContext==2011701)then
  npctask1()
elseif(gContext==2011702)then
  npctask2()
elseif(gContext==2011703)then
  npctask3()
elseif(gContext==2011704)then
  npctask4()
elseif(gContext==2011705)then
 npctask5()
elseif(gContext==2011706)then
 npctask6()
elseif(gContext==2011707)then
 npctask7()
elseif(gContext==2011708)then
 npctask8()
elseif(gContext==2011709)then
 npctask9()
elseif(gContext==2011710)then
 npctask10()
elseif(gContext==2011711)then
 npctask11()
elseif(gContext==2011712)then
 npctask12()
elseif(gContext==2011713)then
 npctask13()
elseif(gContext==2011714)then
 npctask14()
