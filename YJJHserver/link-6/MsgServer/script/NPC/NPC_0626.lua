...
--功能选项
function npcmid10()
  Hero:ActFun(102,"[1]恢复--免费 2062601",0)
end

function npcmid101()
  Hero:ActFun(102,"[1]恢复--1银 2062602",0)
end

function npcmid102()
  Hero:ActFun(102,"[1]恢复--3银 2062603",0)
end

function npcmid103()
  Hero:ActFun(102,"[1]恢复--5银 2062604",0)
end

function npcmid104()
  Hero:ActFun(102,"[1]恢复--8银 2062605",0)
end

function npcmid105()
  Hero:ActFun(102,"[1]恢复--12银 2062606",0)
end

function npcmid106()
  Hero:ActFun(102,"[1]恢复--15银 2062607",0)
end

function npcmid107()
  Hero:ActFun(102,"[1]恢复--18银 2062608",0)
end

function npcmid108()
  Hero:ActFun(102,"[1]恢复--20银 2062609",0)
end

function npcmid109()
  Hero:ActFun(102,"[1]恢复--25银 2062610",0)
end
