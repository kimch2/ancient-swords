		        ...
		        if(Hero:ActFun(1080,"task state 3",20001) == true)then
			        ...
			        if(Hero:GetGiftMask(false) == 0)then            --如果数据库没有物品，继续判断，有则提示背包已满，结束
						...
						Hero:ActFun(1001,"Syngrow += 3",0)                        --帮贡+1
						        Hero:ActFun(1080,"task end 9",20001)
...
if(gContext==3120025)then
  npcAct1()
elseif(gContext==3120026)then
  npcAct2()
elseif(gContext==3120027)then
  npcAct3()
end
