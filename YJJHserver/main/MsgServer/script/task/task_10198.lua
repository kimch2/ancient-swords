...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 6",4) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",4) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 6",4)				  --设置任务状态为1
      else
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then
    Hero:ActFun(1080,"step = 6",4)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010198)then
  npcAct1()
elseif(gContext==3010199)then
  npcAct2()
elseif(gContext==3010200)then
  npcAct3()
end
