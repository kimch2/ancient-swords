...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 47",10001) == true)then

	if(Hero:ActFun(1080,"task state 3",10001) == true)then
		Hero:ActFun(1080,"task end 47",10001)
...
if(gContext==3020139)then	
  npcAct1()
elseif(gContext==3020140)then

  npcAct2()
elseif(gContext==3020141)then
  npcAct3()
end
