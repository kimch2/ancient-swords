...
function npcAct1()
	...
	elseif(Hero:ActFun(1080,"task has 0",25) == true)then				--判断任务链
		...
		if(Hero:ActFun(1080,"step == 1",25) == true)then				--判断任务步骤
		

	  	if(Hero:ActFun(1080,"task state 0",25) == true)then				--判断任务状态
			
			
			 Hero:ActFun(1080,"task accept 1",25)				--设置任务状态为1
			else
...
function npcAct3()
	...
	elseif(Hero:ActFun(1080,"task has 0",25) == true)then					--判断任务链是否建立，建立则进入下一步
 	 Hero:ActFun(1080,"step = 1",25)					 --设置此步骤为0
...
if(gContext==3011310)then	
  npcAct1()
elseif(gContext==3011311)then
  npcAct2()
elseif(gContext==3011312)then
  npcAct3()
end
