...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",6) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 7",6) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",6) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 7",6)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",6) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",6) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 7",6)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",6)				--设置任务步骤数加1
      Hero:ActFun(498,"5",310003)
      Hero:ActFun(1001,"exp += 44000",0)			--给经验
      --Hero:ActFun(1001,"petexp += 22000",0)			--给宠物经验
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",6) == true)then
    Hero:ActFun(1080,"step = 7",6)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010300)then
  npcAct1()
elseif(gContext==3010301)then
  npcAct2()
elseif(gContext==3010302)then
  npcAct3()
end
