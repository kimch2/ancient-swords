	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
		...
		if(Hero:ActFun(1080,"step == 1",3) == true)then				--判断任务步骤
	  		...
	  		if(Hero:ActFun(1080,"task state 0",3) == true)then				--判断任务状态
			 	...
			 	Hero:ActFun(1080,"task accept 1",3)				--设置任务状态为1
			else
	 	...
	 	Hero:ActFun(1080,"task accept 1",3)				--设置任务状态为1
	 	Hero:ActFun(1001,"exp += 100",0)       --答题2
...
function npcAct2()
	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
	    ...
	    --判断任务是否已完成，已完成则进入下一步
	     ...
	     Hero:ActFun(1080,"task end 1",3)				--设置第一步状态为完成
	     Hero:ActFun(1080,"step += 1",3)				--设置任务步骤数加1
--	   Hero:ActFun(1046,"3 2",3)					     --马上接取下一个，暂时不用
...
function npcAct3()
 	 ...
 	 Hero:ActFun(127,"新手任务不能放弃哦",0)					 --显示系统文字
...
function npcAct4()
	...
	if(Hero:ActFun(1080,"mask == 3",3) == true)then					--判断掩码，有掩码则进入下一步
 	 Hero:ActFun(127,"任务已经完成过了",0)					 --显示系统文字
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then					--判断任务链是否建立，建立则进入下一步
 	 Hero:ActFun(1080,"step = 2",3)					 --设置此步骤为0
	else
 	 Hero:ActFun(127,"未接受任务",0)					 --显示系统文字
	end
...
function npcAct5()
	...
	elseif(Hero:ActFun(1080,"task has 0",3) == true)then				--判断任务链
	 	...
	 	if(Hero:ActFun(1080,"step == 2",3) == true)then				--判断任务步骤
	  		...
	  		elseif(Hero:ActFun(1080,"task state 3",3) == true)then				--判断任务状态
	     			...
	     			Hero:ActFun(1080,"task end 2",3)				--设置第一步状态为完成
	     			Hero:ActFun(1080,"step += 1",3)				--设置任务步骤数加1
	     			Hero:ActFun(1001,"money += 2000",2)			--给碎银
	     			Hero:ActFun(1001,"exp += 50",0)
	     			--Hero:ActFun(1001,"petexp += 50",0)
						Hero:ActFun(1046,"3 3",3)					     --马上接取下一个，暂时不用
