...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 1",4) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",4) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 1",4)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",4) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",4) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 1",4)				--设置第一步状态为完成
      ...
      Hero:ActFun(1046,"4 2",3)					     --马上接取下一个
