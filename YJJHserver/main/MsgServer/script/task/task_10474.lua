...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",10) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 11",10) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",10) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 11",10)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",10) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",10) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 11",10)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",10)				--设置任务步骤数加1
      Hero:ActFun(498,"10",310007)
      Hero:ActFun(1001,"exp += 130000",0)			--给经验
      --Hero:ActFun(1001,"petexp += 130000",0)			--给宠物经验
	     Hero:ActFun(1001,"money += 8836",2)
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",10) == true)then
    Hero:ActFun(1080,"step = 11",10)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010474)then
  npcAct1()
elseif(gContext==3010475)then
  npcAct2()
elseif(gContext==3010476)then
  npcAct3()
end
