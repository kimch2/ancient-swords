	    ...
	    if(Hero:ActFun(1102,"countfemale == 1",0) == true)then		      --判断男女各1
	      if(Hero:ActFun(1102,"countmale == 1",0) == true)then				    --判断男女各1
	      	if(Hero:ActFun(1102,"active 0 0",0) == true)then
	       			...
	       			if(Hero:ActFun(1116,"",110816)== true)then

	       				Hero:ActFun(1116,"",110818)
	       			else
	  ...
	  if(Hero:ActFun(1102,"count == 2",0) == true)then				      --判断队伍2人
	    if(Hero:ActFun(1102,"countfemale == 1",0) == true)then		      --判断男女各1
	      if(Hero:ActFun(1102,"countmale == 1",0) == true)then				    --判断男女各1
	      	if(Hero:ActFun(1102,"active 0 0",0) == true)then
						if(Hero:ActFun(1102,"teamlead 0 0",0) == true)then
	       			if(Hero:ActFun(1116,"",110817)== true)then
	       				Hero:ActFun(1116,"",110831)
	       			else
	       				Hero:ActFun(1116,"",110837)
	       			end
	       		else
...
if(gContext==3010816)then
  npcAct1()
elseif(gContext==3010817)then
  npcAct2()
elseif(gContext==3010818)then
  npcAct3()
end
