...
function npcAct1()
	...
	elseif(Hero:ActFun(1080,"task has 0",24) == true)then				--判断任务链
		...
		if(Hero:ActFun(1080,"step == 7",24) == true)then				--判断任务步骤
		

	  	if(Hero:ActFun(1080,"task state 0",24) == true)then				--判断任务状态
			
			
			 Hero:ActFun(1080,"task accept 7",24)				--设置任务状态为1
			else
...
function npcAct2()
	...
	elseif(Hero:ActFun(1080,"task has 0",24) == true)then				--判断任务链
	    ...
	    --判断任务是否已完成，已完成则进入下一步
	     ...
	     Hero:ActFun(1080,"task end 7",24)				--设置第一步状态为完成
...
function npcAct3()
	...
	elseif(Hero:ActFun(1080,"task has 0",24) == true)then					--判断任务链是否建立，建立则进入下一步
 	 Hero:ActFun(1080,"step = 7",24)					 --设置此步骤为0
