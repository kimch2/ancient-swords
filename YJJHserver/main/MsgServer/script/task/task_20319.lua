...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 107",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
		Hero:ActFun(1080,"task end 107",10001)
...
if(gContext==3020319)then	
  npcAct1()
elseif(gContext==3020320)then
  npcAct2()
elseif(gContext==3020321)then
  npcAct3()
end
