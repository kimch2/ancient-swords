...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 24",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",141004) == true)then		--删除任务道具
		Hero:ActFun(1080,"task end 24",10001)
...
if(gContext==3020070)then	
  npcAct1()
elseif(gContext==3020071)then
  npcAct2()
elseif(gContext==3020072)then
  npcAct3()
end
