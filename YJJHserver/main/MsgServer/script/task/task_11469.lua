...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",35) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 11",35) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",35) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 11",35)				          --设置任务状态为1
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",35) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 11",35) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",35) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 11",35)				            --设置第一步状态为完成
...
if(gContext==3011469)then	
  npcAct1()
elseif(gContext==3011470)then
  npcAct2()
elseif(gContext==3011471)then
  npcAct3()
end
