...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",86) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",86) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",86) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 2",86)				          --设置任务状态为1
      else
      ...
      Hero:ActFun(127,"已经完成了任务",0)  	 	                              --显示系统文字
		...
		Hero:ActFun(1080,"task new 2",86)
    Hero:ActFun(1080,"task accept 2",86)				              --设置任务状态为1
  end
end
  ...
  elseif(Hero:ActFun(1080,"task has 0",86) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 2",86) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",86) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 2",86)				            --设置第一步状态为完成
        Hero:ActFun(1080,"step += 1",86)
				Hero:ActFun(1001,"exp += 31800",0)
				Hero:ActFun(1001,"money += 2100",2)
				Hero:ActFun(498,"0",620036)
				Hero:ActFun(1046,"86 3",3)	
...
if(gContext==3010696)then	
  npcAct1()
elseif(gContext==3010697)then
  npcAct2()
elseif(gContext==3010698)then
  npcAct3()
end
