...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",36) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",36) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",36) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 3",36)				          --设置任务状态为1
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",36) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",36) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",36) == true)then				--判断任务状态
        	...
        	Hero:ActFun(1080,"task end 3",36)				            --设置第一步状态为完成
        	Hero:ActFun(1080,"step += 1",36)
        	--Hero:ActFun(1080,"task delete 1",36)
        	--Hero:ActFun(1080,"daymask += 27",36)
					Hero:ActFun(1001,"exp += 80000",0) 
					Hero:ActFun(1001,"money += 10000",2)
					--Hero:ActFun(519,"1 1",504003)
					--Hero:ActFun(519,"1 1",650004)
					--Hero:ActFun(314,"",1)
					Hero:ActFun(498,"6",320006)
...
if(gContext==3010810)then	
  npcAct1()
elseif(gContext==3010811)then
  npcAct2()
elseif(gContext==3010812)then
  npcAct3()
end
