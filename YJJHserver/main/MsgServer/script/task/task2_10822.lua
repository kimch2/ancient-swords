...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",37) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 3",37) == true)then		      --判断任务步骤
...
function npcAct3()
--	Hero:ActFun(1080,"task new 3",37)
  Hero:ActFun(1080,"task accept 3",37)
  result=true;
end
...
if(gContext==110822)then	
  npcAct1()
elseif(gContext==110823)then
  npcAct2()
 elseif(gContext==110824)then
  npcAct3()
elseif(gContext==110833)then
  npcAct4()
end
