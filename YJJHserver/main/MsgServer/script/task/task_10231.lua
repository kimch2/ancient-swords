...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 5",5) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",5) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 5",5)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",5) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 5",5)				--设置第一步状态为完成
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",5) == true)then
    Hero:ActFun(1080,"step = 5",5)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010231)then
  npcAct1()
elseif(gContext==3010232)then
  npcAct2()
elseif(gContext==3010233)then
  npcAct3()
end
