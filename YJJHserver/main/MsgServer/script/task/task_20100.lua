...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 34",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
		Hero:ActFun(1080,"task end 34",10001)
...
if(gContext==3020100)then	
  npcAct1()
elseif(gContext==3020101)then
  npcAct2()
elseif(gContext==3020102)then
  npcAct3()
end
