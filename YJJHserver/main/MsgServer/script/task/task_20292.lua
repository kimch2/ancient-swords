...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 98",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
		Hero:ActFun(1080,"task end 98",10001)
...
if(gContext==3020292)then	
  npcAct1()
elseif(gContext==3020293)then
  npcAct2()
elseif(gContext==3020294)then
  npcAct3()
end
