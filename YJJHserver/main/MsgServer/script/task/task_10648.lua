--接受任务操作
function npcAct1()
  if(Hero:ActFun(1080,"daymask == 3",81) == true)then		        --判断掩码
    Hero:ActFun(127,"任务已经完成过了",0)				                            --显示系统文字
  elseif(Hero:ActFun(1080,"task has 0",81) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 1",81) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",81) == true)then				    --判断任务状态
      	Hero:ActFun(1080,"task new 1",81)
        Hero:ActFun(1080,"task accept 1",81)				          --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",81) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 1",81) == true)then				  --判断任务步骤
      ...
      --判断任务是否已完成，已完成则进入下一步
      elseif(Hero:ActFun(1080,"task state 2",81) == true)then				--判断任务状态
        Hero:ActFun(127,"任务已经完成了",0)				                          --显示系统文字
      elseif(Hero:ActFun(1080,"task state 3",81) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 1",81)				            --设置第一步状态为完成
	...
	if(Hero:ActFun(1080,"daymask2 == 10",0) == false)then
      ...
      elseif(Hero:ActFun(1080,"task state 1",81) == true)then				--判断任务是否满足完成条件，不满足则进入下一步
