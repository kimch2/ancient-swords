  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 8",1) == true)then		      --判断任务步骤
      if(Hero:ActFun(1080,"task state 0",1) == true)then				    --判断任务状态
        Hero:ActFun(1080,"task accept 8",1)				          --设置任务状态为1
      else
  ...
  elseif(Hero:ActFun(1080,"task has 0",1) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 8",1) == true)then				  --判断任务步骤
      ...
      elseif(Hero:ActFun(1080,"task state 3",1) == true)then				--判断任务状态
        Hero:ActFun(1080,"task end 8",1)				            --设置第一步状态为完成
...
if(gContext==3010576)then
  npcAct1()
elseif(gContext==3010577)then
  npcAct2()
elseif(gContext==3010578)then
  npcAct3()
end
