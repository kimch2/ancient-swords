...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",37) == true)then				      --判断任务链
    if(Hero:ActFun(1080,"step == 1",37) == true)then		      --判断任务步骤
...
function npcAct3()
	Hero:ActFun(1080,"task new 1",37)
  Hero:ActFun(1080,"task accept 1",37)
  result=true;
end
...
if(gContext==110816)then	
  npcAct1()
elseif(gContext==110817)then
  npcAct2()
elseif(gContext==110818)then
  npcAct3()
elseif(gContext==110831)then
  npcAct4()
end
