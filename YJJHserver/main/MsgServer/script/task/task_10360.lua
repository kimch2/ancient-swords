...
function npcAct1()
  ...
  elseif(Hero:ActFun(1080,"task has 0",8) == true)then				--判断任务链
    if(Hero:ActFun(1080,"step == 9",8) == true)then		--判断任务步骤
      if(Hero:ActFun(1080,"task state 0",8) == true)then				  --判断任务状态
        Hero:ActFun(1080,"task accept 9",8)				  --设置任务状态为1
      else
...
function npcAct2()
  ...
  elseif(Hero:ActFun(1080,"task has 0",8) == true)then				--判断任务链
    ...
    elseif(Hero:ActFun(1080,"task state 3",8) == true)then				--判断任务状态
      Hero:ActFun(1080,"task end 9",8)				--设置第一步状态为完成
      Hero:ActFun(1080,"step += 1",8)				--设置任务步骤数加1
      Hero:ActFun(1001,"exp += 75000",0)			--给经验
      --Hero:ActFun(1001,"petexp += 75000",0)			--给宠物经验
	     Hero:ActFun(1001,"money += 5476",2)
      Hero:ActFun(498,"5",310007)
...
function npcAct3()
  ...
  elseif(Hero:ActFun(1080,"task has 0",8) == true)then
    Hero:ActFun(1080,"step = 9",8)
  else
    Hero:ActFun(127,"未接受任务",0)
  end
end

if(gContext==3010360)then
  npcAct1()
elseif(gContext==3010361)then
  npcAct2()
elseif(gContext==3010362)then
  npcAct3()
end
