...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 102",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",144009) == true)then
		Hero:ActFun(1080,"task end 102",10001)
...
if(gContext==3020304)then	
  npcAct1()
elseif(gContext==3020305)then
  npcAct2()
elseif(gContext==3020306)then
  npcAct3()
end
