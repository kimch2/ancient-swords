...
--完成任务操作
function npcAct2()
if(Hero:ActFun(1080,"step == 71",10001) == true)then
	if(Hero:ActFun(1080,"task state 3",10001) == true)then
	if(Hero:ActFun(498,"1",143007) == true)then
		Hero:ActFun(1080,"task end 71",10001)
...
if(gContext==3020211)then	
  npcAct1()
elseif(gContext==3020212)then
  npcAct2()
elseif(gContext==3020213)then
  npcAct3()
end
