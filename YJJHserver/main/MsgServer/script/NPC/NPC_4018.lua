...
--功能选项
function npcmid10()
  Hero:ActFun(102,"[6]饰品店 2401801",0)
end
--任务2308 
function npcmid023080()
  Hero:ActFun(102,"[44]失去的记忆（1） 2401804",0)  --接任务
end

function npcmid023081()
  Hero:ActFun(102,"[3]失去的记忆（1） 2401805",0)  --未完成
end

function npcmid023082()
  Hero:ActFun(102,"[22]失去的记忆（1） 2401804",0)  --交任务
end

--任务2309 
function npcmid023090()
  Hero:ActFun(102,"[44]失去的记忆（2） 2401806",0)  --接任务
end

function npcmid023091()
  Hero:ActFun(102,"[3]失去的记忆（2） 2401807",0)  --未完成
end

function npcmid023092()
  Hero:ActFun(102,"[22]失去的记忆（2） 2401806",0)  --交任务
end
...
function npcmid28010()
  Hero:ActFun(102,"[44]清理背包 2401803",0)
end

--任务101完成
function npcmid28011()
  Hero:ActFun(102,"[22]清理背包 2401802",0)
end

--转向选项  
function npctask1()
  Hero:ActFun(1046,"4018",2)
end
...
elseif(gContext==2401801)then
 npctask1()
elseif(gContext==2401802)then
 npctask2()
elseif(gContext==2401803)then
 npctask3()
elseif(gContext==2401804)then
 npctask4()
elseif(gContext==2401805)then
 npctask5()
elseif(gContext==2401806)then
 npctask6()
elseif(gContext==2401807)then
 npctask7()
end
