...
function npcmid03011()
  Hero:ActFun(102,"[22]领取武器 2402001",0)

end
function npcmid03012()
  Hero:ActFun(102,"[44]回复张择端 2402012",0)

end

--功能选项
function npcmid10()
    Hero:ActFun(102,"[6]武器商店 2402002",0)
end
...
elseif(gContext==2402001)then
 npctask1()
elseif(gContext==2402002)then
 npctask2()
elseif(gContext==2402012)then
 npctask3()
end
