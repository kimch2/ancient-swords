--表头
function npctop1()
  Hero:ActFun(101,"&&<0_加入唐门，你就要遵守我唐门的规矩。>",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[44]领取师门任务 2230105",0)
end

function npcmid11()
  Hero:ActFun(102,"[7]门派介绍 2230101",0)
end

function npcmid101()
  Hero:ActFun(102,"[22]交师门任务 2230106",0)
end

function npcmid1031()
  Hero:ActFun(102,"[22]拜入唐门，成为唐门弟子 2230103",0)
end

function npcmid1032()
  Hero:ActFun(102,"[1]切换主副职业 2230102",0)
end

function npcmid1033()
  Hero:ActFun(102,"[1]加入第二门派 2230104",0)
end

function npcmid1034()
  Hero:ActFun(102,"[1]兑换师门称号 2230108",0)
end
function npcmid1035()
  Hero:ActFun(102,"[22]帮派拜访 2230113",0)
end
--表尾
function npcTail()
  Hero:ActFun(103,"",0)
...
--转向选项2
function npctask2()
	if(Hero:ActFun(1096,"== 1",1) == false)then
...
function npctask3()
  	...
  	Hero:ActFun(1080,"task end 15",1)
  	Hero:ActFun(1080,"step += 1",1)
  	Hero:ActFun(1080,"task accept 16",1)
...
function npctask4()
	if(Hero:ActFun(1001,"level >= 45",0) == true)then				--判断人物等级
		if(Hero:ActFun(1096,"== 1",1) == false)then				--判断主职业是否唐门
			if(Hero:ActFun(1096,"== 1",2) == false)then				--判断副职业是否唐门
				if(Hero:ActFun(1096,"== 0",2) == true)then				--判断副职业是否唐门
					Hero:ActFun(1096,"= 1",2)
				else
					Hero:ActFun(127,"你已经有副职业，不能再转职",0)
				end
			else
				Hero:ActFun(127,"你已经是唐门弟子",0)
			end
		else
			Hero:ActFun(127,"你已经是唐门弟子",0)
		end
...
function npctask8()
	...
	Hero:ActFun(102,"[1]【唐花乍现】500点师门贡献 2230109",0)
	Hero:ActFun(102,"[1]【唐门君子】1000点师门贡献 2230110",0)
	Hero:ActFun(102,"[1]【叱咤风云】3000点师门贡献 2230111",0)
	Hero:ActFun(102,"[1]【天罗神君】5000点师门贡献 2230112",0)
	Hero:ActFun(103,"",0)
end

function npctask9()
	if(Hero:ActFun(1001,"Profession == 1",0) == true)then							  --判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4001",0) == true)then				--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 1",4001) == true)then			--已有的称号大于1级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于1级
				if(Hero:ActFun(1001,"jobcon > 499",0) == true)then						--判断贡献度是否达到500
					Hero:ActFun(1001,"jobcon -= 500",0)
					Hero:ActFun(1001,"userholdtitle = 1",4001)									--把已有称号设为1级
				else																													--贡献度不足
		...
		if(Hero:ActFun(1001,"jobcon > 499",0) == true)then								--判断贡献度是否达到500
			Hero:ActFun(1001,"jobcon -= 500",0)
			Hero:ActFun(1001,"userholdtitle += 4001",1)											--增加1级门派称号
		else																															--贡献度不足
			Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
		end
	end
	else
		Hero:ActFun(127,"只有唐门弟子可以获得本派师门称号。",0)
	end
end
...
function npctask10()
	if(Hero:ActFun(1001,"Profession == 1",0) == true)then								--判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4001",0) == true)then				--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 2",4001) == true)then			--已有的称号大于2级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于2级
				if(Hero:ActFun(1001,"jobcon > 999",0) == true)then						--判断贡献度是否达到1000
					Hero:ActFun(1001,"jobcon -= 1000",0)
					Hero:ActFun(1001,"userholdtitle = 2",4001)									--把已有称号设为2级
				else																													--贡献度不足
					Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 999",0) == true)then							--判断贡献度是否达到1000
				Hero:ActFun(1001,"jobcon -= 1000",0)
				Hero:ActFun(1001,"userholdtitle += 4001",2)										--增加1级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask11()
	if(Hero:ActFun(1001,"Profession == 1",0) == true)then               --判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4001",0) == true)then     	--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 3",4001) == true)then 		--已有的称号大于3级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于3级
				if(Hero:ActFun(1001,"jobcon > 2999",0) == true)then						--判断贡献度是否达到3000
					Hero:ActFun(1001,"jobcon -= 3000",0)
					Hero:ActFun(1001,"userholdtitle = 3",4001)									--把已有称号设为3级
				else																													--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 2999",0) == true)then        			--判断贡献度是否达到3000
				Hero:ActFun(1001,"jobcon -= 3000",0)
				Hero:ActFun(1001,"userholdtitle += 4001",3)         					--增加3级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask12()
	if(Hero:ActFun(1001,"Profession == 1",0) == true)then              	--判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4001",0) == true)then     	--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 4",4001) == true)then 		--已有的称号大于等于4级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于4级
				if(Hero:ActFun(1001,"jobcon > 4999",0) == true)then  					--判断贡献度是否达到5000
					Hero:ActFun(1001,"jobcon -= 5000",0)
					Hero:ActFun(1001,"userholdtitle = 4",4001)									--把已有称号设为4级
				else																													--贡献度不足
					Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 4999",0) == true)then        			--判断贡献度是否达到5000
				Hero:ActFun(1001,"jobcon -= 5000",0)
				Hero:ActFun(1001,"userholdtitle += 4001",4)         					--增加4级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask13()
if(Hero:ActFun(1080,"step == 164",20001) == true)then
...
if(Hero:ActFun(1080,"step == 164",20001) == true)then
 ...
 --显示表尾
 npcTail()
elseif(gContext==2230101)then
 npctask1()
elseif(gContext==2230102)then
 npctask2()
elseif(gContext==2230103)then
 npctask3()
elseif(gContext==2230104)then
 npctask4()
elseif(gContext==2230105)then
 npctask5()
elseif(gContext==2230106)then
 npctask6()
elseif(gContext==2230107)then
 npctask7()
elseif(gContext==2230108)then
npctask8()
elseif(gContext==2230109)then
npctask9()
elseif(gContext==2230110)then
npctask10()
elseif(gContext==2230111)then
npctask11()
elseif(gContext==2230112)then
npctask12()
elseif(gContext==2230113)then
npctask13()
end
