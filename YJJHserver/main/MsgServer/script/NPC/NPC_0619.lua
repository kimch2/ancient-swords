...
--功能选项
function npcmid10()
  --Hero:ActFun(102,"[1]领取双倍 2061901",0)
  Hero:ActFun(102,"[1]冻结双倍 2061902",0)
  Hero:ActFun(102,"[1]解除冻结 2061903",0)
  Hero:ActFun(102,"[1]巫蛊祭坛 2061906",0)
end
...
Hero:ActFun(102,"[1]一小时 2061904",0)
Hero:ActFun(102,"[1]两小时 2061905",0)
Hero:ActFun(103,"",0)
end
...
function npctask6()
	...
	Hero:ActFun(102,"[5]进入巫蛊祭坛 2061907",0)
	Hero:ActFun(103,"",0)
end
...
function npctask7()
	...
	elseif(Hero:ActFun(123,"19:30 21:30",4) == true)then
		...
		Hero:ActFun(127,"每天的11:30-14:30和19:30-21:30才能进入祭坛挑战",0)
	end
end
