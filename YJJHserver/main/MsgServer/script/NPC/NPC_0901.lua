...
--表头
function npctop1()
  Hero:ActFun(101,"&&<0_城上斜阳画角衰，沈园非复旧池台。>",0)
end

--任务 0707
function npcmid07070()
  Hero:ActFun(102,"[44]云梦之端 2090101",0)
end
...
function npcmid07072()
  Hero:ActFun(102,"[22]云梦之端 2090101",0)
end

--任务 0801
function npcmid08010()
  Hero:ActFun(102,"[44]人定胜天 2090103",0)
end

function npcmid08011()
  Hero:ActFun(102,"[3]人定胜天 2090104",0)
end

function npcmid08012()
  Hero:ActFun(102,"[22]人定胜天 2090103",0)
end

--任务 0802
function npcmid08020()
  Hero:ActFun(102,"[44]钗头凤 2090105",0)
end

function npcmid08021()
  Hero:ActFun(102,"[3]钗头凤 2090106",0)
end

function npcmid08022()
  Hero:ActFun(102,"[22]钗头凤 2090105",0)
end

--任务 0803
function npcmid08030()
  Hero:ActFun(102,"[44]钗头凤（1） 2090107",0)
end

function npcmid08031()
  Hero:ActFun(102,"[3]钗头凤（1） 2090108",0)
end

function npcmid08032()
  Hero:ActFun(102,"[22]钗头凤（1） 2090107",0)
end

--任务 0804
function npcmid08040()
  Hero:ActFun(102,"[44]伤心桥下春波绿 2090109",0)
end

function npcmid08041()
  Hero:ActFun(102,"[3]伤心桥下春波绿 2090110",0)
end

function npcmid08042()
  Hero:ActFun(102,"[22]伤心桥下春波绿 2090109",0)
end

--任务 0805
function npcmid08050()
  Hero:ActFun(102,"[44]伤心桥下春波绿（1） 2090111",0)
end

function npcmid08051()
  Hero:ActFun(102,"[3]伤心桥下春波绿（1） 2090112",0)
end

function npcmid08052()
  Hero:ActFun(102,"[22]伤心桥下春波绿（1） 2090111",0)
end

--任务 0814
function npcmid08140()
  Hero:ActFun(102,"[44]此生不换（1） 2090113",0)
end

function npcmid08141()
  Hero:ActFun(102,"[3]此生不换（1） 2090114",0)
end

function npcmid08142()
  Hero:ActFun(102,"[22]此生不换（1） 2090113",0)
end

--任务 0815
function npcmid08150()
  Hero:ActFun(102,"[44]此生不换（2） 2090115",0)
end

function npcmid08151()
  Hero:ActFun(102,"[3]此生不换（2） 2090116",0)
end

function npcmid08152()
  Hero:ActFun(102,"[22]此生不换（2） 2090115",0)
end

--任务 3701
function npcmid37010()
  Hero:ActFun(102,"[44]鸳鸯眷侣 2090117",0)
end

function npcmid37011()
  Hero:ActFun(102,"[3]鸳鸯眷侣 2090118",0)
end

function npcmid37012()
  Hero:ActFun(102,"[22]鸳鸯眷侣 2090117",0)
end

--任务 3702
function npcmid37020()
  Hero:ActFun(102,"[44]朝朝暮暮 2090119",0)
end

function npcmid37021()
  Hero:ActFun(102,"[3]朝朝暮暮 2090120",0)
end

function npcmid37022()
  Hero:ActFun(102,"[22]朝朝暮暮 2090119",0)
end

--任务 3704
function npcmid37040()
  Hero:ActFun(102,"[44]天上人间 2090121",0)
end

function npcmid37041()
  Hero:ActFun(102,"[3]天上人间 2090122",0)
end

function npcmid37042()
  Hero:ActFun(102,"[22]天上人间 2090121",0)
end

--任务 3705
function npcmid37050()
  Hero:ActFun(102,"[44]比翼双飞 2090123",0)
end

function npcmid37051()
  Hero:ActFun(102,"[3]比翼双飞 2090124",0)
end

function npcmid37052()
  Hero:ActFun(102,"[22]比翼双飞 2090123",0)
end
...
elseif(gContext==2090116)then
  npctask16()
elseif(gContext==2090117)then
  npctask17()
elseif(gContext==2090118)then
  npctask18()
elseif(gContext==2090119)then
  npctask19()
elseif(gContext==2090120)then
  npctask20()
elseif(gContext==2090121)then
  npctask21()
elseif(gContext==2090122)then
  npctask22()
elseif(gContext==2090123)then
  npctask23()
elseif(gContext==2090124)then
  npctask24()
end
