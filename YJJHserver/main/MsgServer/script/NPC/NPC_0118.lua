...
function npcmid023081()
  Hero:ActFun(102,"[3]失去的记忆（1） 2011805",0)  --未完成
end

function npcmid023082()
  Hero:ActFun(102,"[22]失去的记忆（1） 2011804",0)  --交任务
end

--任务2309 
function npcmid023090()
  Hero:ActFun(102,"[44]失去的记忆（2） 2011806",0)  --接任务
end

function npcmid023091()
  Hero:ActFun(102,"[3]失去的记忆（2） 2011807",0)  --未完成
end

function npcmid023092()
  Hero:ActFun(102,"[22]失去的记忆（2） 2011806",0)  --交任务
end
...
function npcmid28010()
  Hero:ActFun(102,"[44]清理背包 2011803",0)
end

--任务101完成
function npcmid28011()
  Hero:ActFun(102,"[22]清理背包 2011802",0)
end

--转向选项  
function npctask1()
  Hero:ActFun(1046,"118",2)
end
...
elseif(gContext==2011801)then
 npctask1()
elseif(gContext==2011802)then
 npctask2()
elseif(gContext==2011803)then
 npctask3()
elseif(gContext==2011804)then
 npctask4()
elseif(gContext==2011805)then
 npctask5()
elseif(gContext==2011806)then
 npctask6()
elseif(gContext==2011807)then
 npctask7()
end
