--表头	
function npctop1()  
  Hero:ActFun(101,"&&<0_若想加入丐帮的话，可以去找帮主金不换。加入丐帮后，可以向丐帮长老简长卿学习战斗技能。>",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[5]江陵 2240401",0)
end

function npcmid11()
  Hero:ActFun(102,"[5]开封 2240402",0)
end

function npcmid12()
  Hero:ActFun(102,"[22]回访洛神 2240403",0)
end
--表尾
function npcTail()
  Hero:ActFun(103,"",0)
...
--显示表头
 ...
 if(Hero:ActFun(1080,"mask == 1",1) == false)then				--判断掩码
		...
		if(Hero:ActFun(1080,"task has 0",1) == true)then				--判断任务链
			...
			if(Hero:ActFun(1080,"step == 22",1) == true)then				--判断任务步骤
...
npcmid11()
 ...
 --显示表尾
 npcTail()
elseif(gContext==2240401)then
 npctask1()
elseif(gContext==2240402)then
 npctask2()
elseif(gContext==2240403)then
 npctask3()
end