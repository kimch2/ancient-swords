...
--功能选项
function npcmid10()
  Hero:ActFun(102,"[1]押镖任务 2061701",0)
end

function npcmid101()
	Hero:ActFun(102,"[1]龙门荒漠 2061704",0)
end
...
function npctask3()
	if(Hero:ActFun(123,"11:45 14:45",4) == true)then
		if(Hero:ActFun(1116,"",10031) == true)then --判断的等级
	...
	elseif(Hero:ActFun(123,"19:45 22:45",4) == true)then
		if(Hero:ActFun(1116,"",10031) == true)then
			if(Hero:ActFun(1116,"",10026) == true)then  --判断次数少于1
				if(Hero:ActFun(1102,"count > 2",0) == true)then
				 	 --if(Hero:ActFun(1013,"using == 2",13) == true)then
			           -- Hero:ActFun(127,"你有权限进入副本",0)
						--Hero:EnterInstance(13,0,1,82,88)
...
function npctask4()
	...
	Hero:ActFun(101,"<0_切记，大漠上敌我难辨，除了你的队友外，就是你的敌人。><br>&&<0_最后，我祝你满载而归！>",0)
	--Hero:ActFun(102,"[1]领取藏宝图 2061702",0)
	Hero:ActFun(102,"[5]进入龙门荒漠 2061703",0)
	Hero:ActFun(103,"",0)
end


--显示选项
if(gContext==2061700)then
...
elseif(gContext==2061701)then
 npctask1()
elseif(gContext==2061702)then
npctask2()
elseif(gContext==2061703)then
npctask3()
elseif(gContext==2061704)then
npctask4()
end
