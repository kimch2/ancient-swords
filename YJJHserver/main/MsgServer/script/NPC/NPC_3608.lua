...
function npcmid03041()
  Hero:ActFun(102,"[22]领取宠物 2360802",0)

end
function npcmid03042()
  Hero:ActFun(102,"[44]回复张择端 2360803",0)

end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[6]宠物商店 2360801",0)
end
...
--显示表尾
 npcTail()
elseif(gContext==2360801)then
 npctask1()
elseif(gContext==2360802)then
 npctask2()
elseif(gContext==2360803)then
 npctask3()
end
