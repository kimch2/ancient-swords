...
--功能选项
function npcmid10()
  Hero:ActFun(102,"[1]恢复--免费 2013201",0)
end

function npcmid101()
  Hero:ActFun(102,"[1]恢复--1银 2013202",0)
end

function npcmid102()
  Hero:ActFun(102,"[1]恢复--3银 2013203",0)
end

function npcmid103()
  Hero:ActFun(102,"[1]恢复--5银 2013204",0)
end

function npcmid104()
  Hero:ActFun(102,"[1]恢复--8银 2013205",0)
end

function npcmid105()
  Hero:ActFun(102,"[1]恢复--12银 2013206",0)
end

function npcmid106()
  Hero:ActFun(102,"[1]恢复--15银 2013207",0)
end

function npcmid107()
  Hero:ActFun(102,"[1]恢复--18银 2013208",0)
end

function npcmid108()
  Hero:ActFun(102,"[1]恢复--20银 2013209",0)
end

function npcmid109()
  Hero:ActFun(102,"[1]恢复--25银 2013210",0)
end
