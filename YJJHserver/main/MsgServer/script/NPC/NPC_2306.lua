...
--功能选项
function npcmid10()
  Hero:ActFun(102,"[6]套装商店 2230602",0)
end

--功能选项
function npcmid23061()
  Hero:ActFun(102,"[22]领取门派套装 2230601",0)
end
...
function npctask1()
  if(Hero:ActFun(508,"47 3",0) == true)then
  	Hero:ActFun(519,"1 1",146991)
  	Hero:ActFun(519,"1 1",116991)
  	Hero:ActFun(519,"1 1",176991)
  	Hero:ActFun(1080,"task end 17",1)
  	Hero:ActFun(1080,"step += 1",1)
  	Hero:ActFun(1080,"task accept 18",1)
...
--显示表头
 ...
 --任务链结构开始	
  if(Hero:ActFun(1080,"mask == 1",1) == false)then				--判断掩码
		...
		if(Hero:ActFun(1080,"task has 0",1) == true)then				--判断任务链
			...
			if(Hero:ActFun(1080,"step == 17",1) == true)then				--判断任务步骤
 ...
 --显示表尾
 npcTail()
elseif(gContext==2230601)then
 npctask1()
 elseif(gContext==2230602)then
 npctask2()
end