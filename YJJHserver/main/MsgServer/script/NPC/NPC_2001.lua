--表头
function npctop1()
  Hero:ActFun(101,"&&<0_勤能补拙，切记。>",0)
end

--功能选项
function npcmid10()
  Hero:ActFun(102,"[44]领取师门任务 2200105",0)
end

function npcmid11()
	Hero:ActFun(102,"[7]门派介绍 2200101",0)
end

function npcmid101()
  Hero:ActFun(102,"[22]交师门任务 2200106",0)
end

function npcmid1031()
  Hero:ActFun(102,"[22]拜入点苍，成为点苍弟子 2200102",0)
end

function npcmid1033()
  Hero:ActFun(102,"[7]加入第二门派 2200104",0)
end
...
function npcmid1034()
  Hero:ActFun(102,"[1]兑换师门称号 2200108",0)
end
function npcmid1035()
  Hero:ActFun(102,"[22]帮派拜访 2200113",0)
end
--表尾
function npcTail()
  Hero:ActFun(103,"",0)
...
function npctask8()
	...
	Hero:ActFun(102,"[1]【百步弓手】500点师门贡献 2200109",0)
	Hero:ActFun(102,"[1]【追风射手】1000点师门贡献 2200110",0)
	Hero:ActFun(102,"[1]【点苍神射】3000点师门贡献 2200111",0)
	Hero:ActFun(102,"[1]【凌云飞将】5000点师门贡献 2200112",0)
	Hero:ActFun(103,"",0)
end

function npctask9()
	if(Hero:ActFun(1001,"Profession == 32",0) == true)then							  --判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4006",0) == true)then				--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 1",4006) == true)then			--已有的称号大于1级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于1级
				if(Hero:ActFun(1001,"jobcon > 499",0) == true)then						--判断贡献度是否达到500
					Hero:ActFun(1001,"jobcon -= 500",0)
					Hero:ActFun(1001,"userholdtitle = 1",4006)									--把已有称号设为1级
				else																													--贡献度不足
		...
		if(Hero:ActFun(1001,"jobcon > 499",0) == true)then								--判断贡献度是否达到500
			Hero:ActFun(1001,"jobcon -= 500",0)
			Hero:ActFun(1001,"userholdtitle += 4006",1)											--增加1级门派称号
		else																															--贡献度不足
			Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
		end
	end
	else
		Hero:ActFun(127,"只有点苍弟子可以获得本派师门称号。",0)
	end
end
...
function npctask10()
	if(Hero:ActFun(1001,"Profession == 32",0) == true)then								--判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4006",0) == true)then				--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 2",4006) == true)then			--已有的称号大于2级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于2级
				if(Hero:ActFun(1001,"jobcon > 999",0) == true)then						--判断贡献度是否达到1000
					Hero:ActFun(1001,"jobcon -= 1000",0)
					Hero:ActFun(1001,"userholdtitle = 2",4006)									--把已有称号设为2级
				else																													--贡献度不足
					Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 999",0) == true)then							--判断贡献度是否达到1000
				Hero:ActFun(1001,"jobcon -= 1000",0)
				Hero:ActFun(1001,"userholdtitle += 4006",2)										--增加1级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask11()
	if(Hero:ActFun(1001,"Profession == 32",0) == true)then               --判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4006",0) == true)then     	--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 3",4006) == true)then 		--已有的称号大于3级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于3级
				if(Hero:ActFun(1001,"jobcon > 2999",0) == true)then						--判断贡献度是否达到3000
					Hero:ActFun(1001,"jobcon -= 3000",0)
					Hero:ActFun(1001,"userholdtitle = 3",4006)									--把已有称号设为3级
				else																													--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 2999",0) == true)then        			--判断贡献度是否达到3000
				Hero:ActFun(1001,"jobcon -= 3000",0)
				Hero:ActFun(1001,"userholdtitle += 4006",3)         					--增加3级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
function npctask12()
	if(Hero:ActFun(1001,"Profession == 32",0) == true)then              	--判断当前职业
		if(Hero:ActFun(1001,"userholdtitle == 4006",0) == true)then     	--已经有了门派称号
			if(Hero:ActFun(1001,"userholdtitle >= 4",4006) == true)then 		--已有的称号大于等于4级
				Hero:ActFun(127,"你已经有此称号了，无需重复兑换。",0)
			else																														--已有的称号小于4级
				if(Hero:ActFun(1001,"jobcon > 4999",0) == true)then  					--判断贡献度是否达到5000
					Hero:ActFun(1001,"jobcon -= 5000",0)
					Hero:ActFun(1001,"userholdtitle = 4",4006)									--把已有称号设为4级
				else																													--贡献度不足
					Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
				end
			end
			...
			if(Hero:ActFun(1001,"jobcon > 4999",0) == true)then        			--判断贡献度是否达到5000
				Hero:ActFun(1001,"jobcon -= 5000",0)
				Hero:ActFun(1001,"userholdtitle += 4006",4)         					--增加4级门派称号
			else																														--贡献度不足
				Hero:ActFun(127,"师门贡献度不够，多做师门任务吧。",0)
			end
		end
...
elseif(gContext==2200107)then
 npctask7()
elseif(gContext==2200108)then
 npctask8()
elseif(gContext==2200109)then
 npctask9()
elseif(gContext==2200110)then
npctask10()
elseif(gContext==2200111)then
npctask11()
elseif(gContext==2200112)then
npctask12()
elseif(gContext==2200113)then
npctask13()
end
